...
public class MessageHead {
	...
	public static final int FEEDBACK 		= 22; //Feedback results (int)
	/** statement of MESSAGE */
	public static final int PUBLIC 				= 31; //Everyone can see this information (String(msg))
	public static final int PRIVATE 			= 32; //Only one person can see this information (String(target + msg))	R
